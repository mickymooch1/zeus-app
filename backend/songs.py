...
GENRE_MOTION_PROMPTS: dict[str, str] = {
    "bluegrass":      "bluegrass band performing energetically, foot stomping rhythm, warm rustic barn lighting, authentic Appalachian mountain energy",
    ...
    "triphop":       "trip-hop vocalist performing slowly, brooding minimal movement, smoky blue noir lighting, melancholic cinematic atmosphere",
    ...
    "westcoasthiphop":  "West Coast rapper performing confidently, laid-back rhythmic movement, warm golden Los Angeles sunset light, relaxed cruising energy",
    ...
    "trance":           "trance DJ performing euphorically, hands raised to a vast crowd, sweeping laser lights, massive festival mainstage energy",
    ...
    "salsa":            "salsa band performing energetically, brass section swaying in unison, dancers spinning, vibrant warm stage lighting, festive Latin celebration energy",
