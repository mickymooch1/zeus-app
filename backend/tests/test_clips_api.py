...
def app_client(tmp_path, monkeypatch):
    ...
    # This suite tests core clip API behavior, not the CLIPS_ENABLED gate
    # (see test_clips_feature_flag.py for that) — open creation to everyone
    # so ordinary/non-admin fixture users can publish as before the flag existed.
