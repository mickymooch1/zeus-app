...
GENRE_COVER_PROMPTS: dict[str, str] = {
    "blues":        "cinematic album cover, weathered Black blues musician with battered guitar in foreground, Mississippi Delta porch at dusk behind him, massive speakers either side, amber oil lamp light, storm clouds over cotton fields, warm ochre and dark navy tones, ultra detailed professional music artwork",
    "soul":         "cinematic album cover, radiant Black woman in sequined golden gown in foreground, massive speakers either side, Motown spotlight from above, lush orchestral musicians in silhouette behind her, red velvet curtains, warm amber and gold, ultra detailed professional music artwork",
    "rnb":          "cinematic album cover, elegant Black woman in deep purple satin in foreground, massive speakers either side, glittering Manhattan skyline at night behind her, soft purple and gold neon reflections, luxury penthouse atmosphere, ultra detailed professional music artwork",
    "country":      "cinematic album cover, rugged American cowboy with acoustic guitar in foreground, massive speakers either side, Monument Valley canyon sunset behind him, blazing orange and crimson sky, wildflowers and sagebrush, ultra detailed professional music artwork",
    "reggae":       "cinematic album cover, beautiful Black woman with long dreadlocks in foreground, massive speakers either side, tropical rainforest and palm trees behind her, Rastafarian colours red gold green, cannabis leaves, dramatic golden sunset, ultra detailed professional music artwork",
    "pop":          "cinematic album cover, glamorous young pop star in sparkling outfit in foreground, massive speakers either side, neon-lit arena stage behind her, enormous LED screens, holographic light beams, confetti explosion, ultra detailed professional music artwork",
    "rock":         "cinematic album cover, electric guitarist in leather jacket in foreground, massive speakers either side, rain-soaked rooftop stage behind him, lightning bolt in bruised purple sky, Marshall amp stacks, pyrotechnic fire pillars, ultra detailed professional music artwork",
    "hiphop":       "cinematic album cover, Black rapper in gold chain jewellery in foreground, massive speakers either side, New York City rooftop at midnight behind him, glittering Manhattan skyline, graffiti mural wall, ultra detailed professional music artwork",
    "lofi":         "cinematic album cover, young woman with headphones at desk in foreground, rain-streaked window with soft city bokeh behind her, warm amber desk lamp, cassette tapes and vinyl records, steaming mug, ultra detailed professional music artwork",
    "edm":          "cinematic album cover, EDM DJ in neon-lit booth in foreground, massive speakers either side, outdoor festival crowd behind them, towering LED screens blazing with neon fractals, laser beams, fire cannons erupting, ultra detailed professional music artwork",
    "acoustic":     "cinematic album cover, female singer-songwriter with vintage acoustic guitar in foreground, Irish meadow at golden hour behind her, rolling green hills and wildflowers, ancient oak trees, ultra detailed professional music artwork",
    "irishjig":     "cinematic album cover, Irish céilí dancer in traditional green and gold costume in foreground, stone-walled pub with blazing turf fireplace behind her, fiddles and tin whistles on walls, Guinness on oak tables, ultra detailed professional music artwork",
    "irishfolk":    "cinematic album cover, solitary Irish bard with acoustic guitar in foreground, Atlantic cliff edge at dawn behind him, ancient stone ruins, dramatic slate blue sky, waves crashing below, ultra detailed professional music artwork",
    "drumandbass":  "cinematic album cover, Black British DJ with headphones in foreground, massive speakers either side, cavernous industrial rave behind him, strobe lights in electric white and ice blue cutting through fog, ultra detailed professional music artwork",
    "grime":        "cinematic album cover, Black grime MC holding microphone in foreground, massive speakers either side, rain-slicked East London council estate at midnight behind him, tower blocks, cold blue streetlight, graffiti-tagged shutters, ultra detailed professional music artwork",
    "ukgarage":     "cinematic album cover, stylish Black British MC in designer clothes in foreground, massive speakers either side, gleaming luxury car and neon-lit London club behind him, wet tarmac reflecting electric blue and pink neon, ultra detailed professional music artwork",
    "jungle":       "cinematic album cover, Black jungle MC on the mic in foreground, massive speakers either side, dark 1993 London warehouse rave behind him, green and gold laser beams through smoke, Jamaican and British flags, ultra detailed professional music artwork",
    "bassline":     "cinematic album cover, Black British DJ at decks in foreground, massive sub-bass speaker wall either side, underground Sheffield warehouse club behind him, red and amber lighting, raw northern underground energy, ultra detailed professional music artwork",
    "house":        "cinematic album cover, DJ at the decks in foreground, massive speakers either side, euphoric Ibiza open-air sunrise terrace behind them, blazing coral and gold Mediterranean sky, crowd with hands raised, palm trees, ultra detailed professional music artwork",
    "bluessoul":    "cinematic album cover, Black woman in crimson evening gown in foreground, jazz club stage behind her, upright bass and piano in shadow, warm mahogany bar and candles, whiskey glass on stage floor, ultra detailed professional music artwork",
    "loversrock":   "cinematic album cover, romantic Black British couple in foreground, moonlit Caribbean beach behind them, tropical flowers, warm pink and gold tiki torch light, turquoise water, palm trees swaying, ultra detailed professional music artwork",
    "ukdrill":      "cinematic album cover, Black drill artist in designer puffer jacket in foreground, massive speakers either side, dark South London estate at night behind him, cold blue CCTV glow, concrete brutalist tower blocks, barbed wire fencing, ultra detailed professional music artwork",
    "kpop":         "cinematic album cover, Korean K-pop idol group in colour-coordinated pastel outfits in foreground, massive speakers either side, futuristic Seoul rooftop stage behind them, enormous holographic displays, cherry blossoms and confetti explosion, ultra detailed professional music artwork",
    "deepsoulblues": "cinematic album cover, elderly Black blues patriarch with resonator guitar in foreground, weathered Mississippi porch at dusk behind him, live oak tree with Spanish moss, fireflies glowing, amber oil lamp on porch rail, ultra detailed professional music artwork",
    "niche":          "cinematic album cover, female vocalist in sequined dress in foreground, massive speakers either side, underground Sheffield warehouse club behind her, purple and blue neon, cigarette smoke swirling, raw Yorkshire underground energy, ultra detailed professional music artwork",
    "ukstreetsoul":   "cinematic album cover, stylish Black British singer in foreground, sun-drenched Peckham backstreet at golden hour behind him, warm amber street lights, graffiti murals, long shadows across pavement, ultra detailed professional music artwork",
    "classical":      "cinematic album cover, orchestra conductor with baton raised in foreground, grand concert hall behind him, enormous chandelier blazing overhead, full symphony in black formal wear, gilded balconies packed with audience, ultra detailed professional music artwork",
    "indie":          "cinematic album cover, indie guitarist with vintage guitar in foreground, intimate underground music venue behind them, exposed brick walls plastered with tour posters, warm amber and red stage lights, ultra detailed professional music artwork",
    "techno":         "cinematic album cover, techno DJ at modular synth wall in foreground, massive speakers either side, dark Berlin underground warehouse behind them, minimal cold white strobes cutting through smoke, exposed concrete pillars, ultra detailed professional music artwork",
    "technhouse":     "cinematic album cover, tech house DJ at sleek decks in foreground, massive speakers either side, minimal underground club interior behind them, black and gunmetal grey architecture, cool blue and amber lighting, ultra detailed professional music artwork",
    "hyperpop":       "cinematic album cover, young hyperpop artist in oversized candy-coloured clothing in foreground, exploding glitter and shattered pixels around them, electric pink and cyan light rays, holographic butterfly wings and melting emoji faces, glitchy digital chaos, ultra detailed professional music artwork",
    "afrobeats":      "cinematic album cover, beautiful Black woman with dreadlocks in foreground, vibrant West African cityscape behind her, massive speakers on each side, Rastafarian colours red gold green, tropical plants, dramatic golden sunset, ultra detailed professional music artwork",
    "amapiano":       "cinematic album cover, well-dressed young Black South African DJ in foreground, massive speakers either side, rooftop party in Johannesburg at golden sunset behind him, city skyline blazing amber, log step dancers in vibrant outfits, ultra detailed professional music artwork",
    "driftphonk":     "cinematic album cover, phonk driver in cap and face mask in foreground, modified Nissan Silvia S15 power-sliding on neon-lit Japanese mountain touge behind him, deep red tail lights, VHS grain and chromatic aberration, dark Memphis aesthetic, ultra detailed professional music artwork",
    ...
    "jazz":            "cinematic album cover, Black jazz musician playing saxophone in foreground, smoky intimate jazz club behind, warm amber and gold lighting, vintage microphone, brick walls, ultra detailed professional music artwork",
}
