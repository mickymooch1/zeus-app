...
GENRE_COVER_PROMPTS: dict[str, str] = {
    ...
    "hyperpop":       "epic hyperpop album cover art, chaotic maximalist digital landscape exploding with electric pink cyan and lime green, glitchy pixel-shattered typography floating in zero gravity, heavily distorted cartoon faces melting into neon fractals, internet meme collage aesthetic, everything too bright too fast too loud, Y2K cyber aesthetic taken to its extreme, ultra-detailed digital illustration, cinematic chaotic neon lighting, professional music artwork",
    "afrobeats":      "epic afrobeats album cover art, breathtaking West African cityscape at golden hour, Lagos or Accra skyline bathed in warm amber and deep coral sunset light, vibrant kente cloth patterns woven into the architecture, Black musicians celebrating in the foreground with traditional talking drums and modern speakers, tropical flowers and palm trees, rich warm golds oranges and greens, joyful euphoric atmosphere, ultra-detailed digital painting, cinematic warm dramatic lighting, professional music artwork",
    "amapiano":       "epic amapiano album cover art, sophisticated South African urban rooftop at golden sunset, Johannesburg skyline glowing in warm amber and burnt orange behind a silhouetted DJ at a sleek setup, well-dressed Black South Africans gathered around in designer fashion, smooth warm golden light washing over polished concrete surfaces, smoke rising lazily from a fire pit nearby, deep beautiful sky fading to indigo, ultra-detailed digital painting, cinematic golden dramatic lighting, professional music artwork",
    "driftphonk":     "epic drift phonk album cover art, cinematic night scene, two modified JDM sports cars drifting through a dark industrial Japanese mountain pass at 3am, angry red neon headlights and tail lights leaving long streaks across wet tarmac, dark Memphis-style graphic overlays, heavy grain and chromatic aberration, aggressive red and black colour palette, cigarette smoke and tyre smoke mixing in cold mountain air, raw underground drift culture, ultra-detailed digital painting, cinematic cold aggressive lighting, professional music artwork",
    "jerseyclub":     "epic Jersey Club album cover art, packed Newark New Jersey club night in full swing, strobe lights blazing in electric white and blue over a sea of bodies locked in fast jerky footwork dance, enormous speaker stacks on either side of a raised DJ booth, neon club signage reflecting off sweaty faces, urban New Jersey skyline visible through floor-to-ceiling windows, raw high-energy East Coast club atmosphere, ultra-detailed digital painting, cinematic dramatic club lighting, professional music artwork",
}
