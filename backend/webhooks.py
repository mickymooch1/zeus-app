...
GENRE_COVER_PROMPTS: dict[str, str] = {
    ...
    "niche":          "epic niche music album cover art, underground Sheffield late-night club, packed dark warehouse dance floor heaving with bodies, female vocalist in sequined dress bathed in purple and blue neon on a low stage, enormous speaker wall thumping sub bass, cigarette smoke swirling through coloured lights, steel girder ceiling, T-bar lighting rig, raw Yorkshire underground rave energy, ultra-detailed digital painting, cinematic dark neon lighting, professional music artwork",
    ...
    "hyperpop":       "epic hyperpop album cover art, young artist in oversized candy-coloured clothing surrounded by exploding glitter and shattered pixels, electric pink and cyan light rays, holographic butterfly wings and melting emoji faces, candy-coloured digital chaos layered over a blown-out bedroom studio, computer desktop aesthetic pushed to its maximalist extreme, distorted vocals visualised as glitching waveforms, youthful internet-era chaos energy, ultra-detailed digital illustration, cinematic oversaturated neon lighting, professional music artwork",
    "afrobeats":      "vibrant African music festival, Black musicians performing, colourful African fabric and patterns, warm golden sunset, joyful dancing crowd, West African city skyline, rich vibrant colours, Afrobeats concert energy",
    "amapiano":       "epic amapiano album cover art, rooftop party in Johannesburg at golden sunset, well-dressed young Black South Africans dancing the log step on a polished concrete terrace, DJ at sleek decks with the city skyline blazing amber and burnt sienna behind them, women in vibrant print dresses and men in tailored fits, braai smoke drifting through warm air, deep indigo sky emerging above, ultra-detailed digital painting, cinematic golden sunset lighting, professional music artwork",
    "driftphonk":     "epic drift phonk album cover art, modified Nissan Silvia S15 power-sliding through a neon-lit Japanese mountain touge at 3am, deep red tail lights burning long streaks across rain-slicked tarmac, dark Memphis rap aesthetic overlaid with VHS grain and chromatic aberration, kanji road signs and guardrails catching the headlights, black and crimson colour palette, tyre smoke and cold mountain air, underground Japanese car culture meets dark Southern trap, ultra-detailed digital painting, cinematic cold aggressive night lighting, professional music artwork",
    "jerseyclub":     "epic Jersey Club album cover art, packed Newark warehouse party in full swing, DJ elevated on a booth firing up hundreds of dancers locked in sharp fast footwork, strobes freezing the blur of rapid footstep patterns on the floor, silhouettes with arms raised, raw East Coast energy, urban Newark skyline glimpsed through grimy warehouse windows, neon signage and sweat-drenched concrete walls, ultra-detailed digital painting, cinematic high-contrast strobe lighting, professional music artwork",
    "afroswing":      "stylish London rooftop at golden hour, warm tropical colours meet urban British aesthetic, smooth romantic atmosphere, Black artists in stylish outfits, afroswing vibes",
}
