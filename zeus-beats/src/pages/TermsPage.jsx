    ...
    <div className="content-page-wrap">
      ...
      <main className="content-page page">
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <p>
            Zeus Beats is an AI-powered music generation platform that helps creators, musicians,
            and businesses produce original music including: AI-generated songs with vocals,
            instrumental tracks, genre-specific compositions, and avatar music videos.
          </p>
          <p>
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <p>
            Zeus Beats uses AI systems including Claude (by Anthropic) and Suno AI for music
            generation. By using the Service, you acknowledge and agree to the following:
          </p>
          <ul>
            <li>
              <strong>AI-generated responses:</strong> All music, lyrics, and content produced
              by Zeus Beats are generated by artificial intelligence. They may contain errors,
              inaccuracies, or unexpected outputs. You are solely responsible for verifying the
              suitability of any AI-generated output before use.
            </li>
            <li>
              <strong>Conversation processing:</strong> Your prompts and messages are transmitted
              to and processed by Anthropic's AI systems in order to generate lyrics and responses.
              By using the Service, you consent to your conversations being processed by Anthropic
              in accordance with{' '}
              <a
            ...
            <li>
              ...
              information in your prompts, as this content will be processed by external API
              infrastructure.
            </li>
            <li>
              <strong>No guarantee of accuracy:</strong> We make no warranty that AI responses
              are accurate, current, or complete. Zeus Beats expressly disclaims liability for
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <p>
            Zeus Beats offers a free tier and paid subscription plans, as well as song credit
            top-up packs. All prices are shown and are inclusive of VAT where applicable.
          </p>
          <p>
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <p>
            ...
            including song credit top-up packs.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>Song credit top-up packs that have been used</li>
          </ul>
          <p>
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <ul>
            ...
            <li>Create content intended to deceive, defame, or harass</li>
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <p>
            ...
            Service (your prompts and uploaded files). By using the Service, you grant us a
            limited, non-exclusive, royalty-free licence to process your content solely for the
            purpose of delivering the Service.
          </p>
          <p>
            <strong>AI-generated outputs:</strong> Music and lyrics generated by Zeus Beats in
            response to your prompts are provided for your use. You are responsible for ensuring
            that AI-generated outputs do not infringe third-party intellectual property rights
            before any commercial use. We make no representation as to the originality or
        ...
        <section style={{ marginBottom: 32 }}>
          ...
          <p>
            ...
            encrypted password), usage data, song generation history, payment information (via
