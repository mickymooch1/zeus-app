...
const GENRE_CATEGORIES: GenreCategory[] = [
  ...
  { id: 'soul',       label: '🎵 Soul & Blues',        color: '#fb923c',
    genres: ['soul','bluessoul','southemsoul','soulrnb','orchestralsoul','classicfunk','gospel','hymns','trapsoul','vocaljazz','scat','swing','rnb','blues','deepsoulblues','chicagoblues','deltablues','swampblues'] },
  ...
  { id: 'country_folk', label: '🤠 Country & Folk',    color: '#d97706',
    genres: ['country','bluegrass','countryamericana','countrypop','countryballad','outlawcountry','outlawcountryrap','folk','acousticballad','folkblues','roots','acousticblues','celticpunk'] },
...
const GENRE_LABEL: Record<string, string> = {
  bluegrass:'Bluegrass', countryballad:'Country Ballad', outlawcountry:'Dark Outlaw Country', outlawcountryrap:'Outlaw Country Rap',
  ...
  ukstreetsoul:'UK Street Soul', technhouse:'Tech House', driftphonk:'Drift Phonk', brazilianphonk:'Brazilian Phonk',
  jerseyclub:'Jersey Club', afroswing:'Afroswing', rastadub:'Rasta Dub', dancehall:'Dancehall',
  ...
  countryamericana:'Country Americana', countrypop:'Country Pop', southemsoul:'Southern Soul', soulrnb:'Soul R&B', orchestralsoul:'Orchestral Soul', classicfunk:'Classic Funk',
  traditionalpop:'Traditional Pop', rocknroll:'Rock & Roll', trap:'Trap',
  eastcoasthiphop:'East Coast Hip-Hop', westcoasthiphop:'West Coast Hip-Hop', poprap:'Pop Rap', synthwave:'Synthwave',
  trance:'Trance', triphop:'Trip-Hop', salsa:'Salsa',
  gospel:'Gospel', hymns:'Hymns', trapsoul:'Trap Soul', meditation:'Meditation', ambient:'Ambient', christmas:'Christmas',
