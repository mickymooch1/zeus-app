  ...
  return (
    <div className="content-page-wrap">
      ...
      <main className="content-page page">
        <h1 className="content-title">Data Deletion Request — Zeus AI Design</h1>
        ...
        <section className="content-section">
          ...
          <h3 style={{ marginTop: '1.25rem', marginBottom: '0.5rem', fontSize: '1rem' }}>
            Option 1 — Delete from your account
          </h3>
          <ol>
            <li>Log in to your account at <a href="https://zeusaidesign.com" className="auth-link">zeusaidesign.com</a></li>
