        ...
        <div style={{ maxWidth: 880, margin: '0 auto', padding: '32px 24px 80px' }}>
          ...
          <div style={{
            ...
            <p style={{ color: '#555', fontSize: 14, marginBottom: 22 }}>
              Describe your song — Zeus Beats writes the lyrics, Suno turns them into music.
            </p>
            ...
            <div style={{ marginBottom: showAdvanced ? 12 : 18 }}>
              <button
                ...
                style={{ background: 'none', border: 'none', color: '#555', fontSize: 12, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 4, padding: 0, letterSpacing: '0.2px' }}
              >
              ...
              <div style={{
                ...
                <div>
                  ...
                  >
                    ...
                    {['British','American (Southern)','Irish','Scottish','Australian','Caribbean','French','Spanish','American Soul','Jamaican','D&B MC','UK Rave MC','American Hip-Hop','K-Pop','West African','South African','American Phonk','New Jersey / Newark'].map((a) => (
