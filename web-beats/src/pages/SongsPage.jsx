...
// genreColor/gLabel are exported so SongCard.jsx (which renders a genre pill
// too) can share this single source of truth instead of duplicating it —
// genres.test.mjs text-scans this file for a literal "const GENRE_CATEGORIES ="
// declaration, so the category data itself must stay physically in this file
// rather than move to the component.
...
function _matchGenreSlug(text) {
  ...
  const checks = [
    ...
    ['reggae', 'reggae'], ['dancehall', 'dancehall'], ['afro', 'afrobeats'], ['lo-fi', 'lofi'], ['lofi', 'lofi'],
    ['classical', 'classical'], ['celtic', 'celticpunk'], ['opera', 'opera'], ['indie', 'indie'], ['blues', 'blues'],
