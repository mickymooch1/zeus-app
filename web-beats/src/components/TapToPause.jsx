...
const circle = {
  position: 'absolute', width: 76, height: 76, borderRadius: '50%', pointerEvents: 'none',
 ...
 * A full-area layer that sits ABOVE the visual but BELOW every control — the
 ...
 */
export default function TapToPause({ paused, onToggle, center, zIndex = 5 }) {
