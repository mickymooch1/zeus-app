...
export const GENRE_CATEGORIES = [
  ...
  { id: 'country_folk', label: '🤠 Country & Folk',    color: '#d97706',
    genres: ['country','traditionalcountry','bluegrass','countryamericana','countrypop','countryballad','outlawcountry','folk','acousticballad','folkblues','roots','acousticblues','celticpunk'] },
