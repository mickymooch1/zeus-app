...
export const GENRE_CATEGORIES = [
  ...
  { id: 'soul',       label: '🎵 Soul & Blues',        color: '#fb923c',
    genres: ['soul','bluessoul','southemsoul','soulrnb','orchestralsoul','classicfunk','gogo','gospel','hymns','trapsoul','vocaljazz','scat','swing','rnb','blues','deepsoulblues','chicagoblues','deltablues','swampblues'] },
  ...
  { id: 'country_folk', label: '🤠 Country & Folk',    color: '#d97706',
    genres: ['country','traditionalcountry','bluegrass','countryamericana','countrypop','countryballad','outlawcountry','outlawcountryrap','folk','acousticballad','folkblues','roots','acousticblues','celticpunk'] },
  ...
  { id: 'pop',        label: '🎶 Pop & Hip Hop',       color: '#f472b6',
    genres: ['pop','patriotic','trap','eastcoasthiphop','westcoasthiphop','poprap','kpop','hiphop','boombap','citypop','neworleansbounce'] },
